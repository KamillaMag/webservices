 ...
 *
 */
@WebServiceClient(name = "CityService", targetNamespace = "http://lab3.webservices.kamilla.ifmo/", wsdlLocation = "http://0.0.0.0:2097/CityService?wsdl")
        ...
        extends Service
{
    ...
    private final static QName CITYSERVICE_QNAME = new QName("http://lab3.webservices.kamilla.ifmo/", "CityService");
    ...
    public CityWebService getCityWebServicePort() {
        return super.getPort(new QName("http://lab3.webservices.kamilla.ifmo/", "CityWebServicePort"), CityWebService.class);
    }
    ...
    public CityWebService getCityWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab3.webservices.kamilla.ifmo/", "CityWebServicePort"), CityWebService.class, features);
    }
